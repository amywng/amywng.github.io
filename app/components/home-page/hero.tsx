        ...
        <div className="relative flex items-center justify-between mt-[49px] z-10 mx-[10%]">
            <div className="flex flex-col items-start text-[#7371FC] z-10">
                ...
                <a 
                    ...
                    className="no-underline bg-[#7371FC] text-white rounded-[100px] 
            ...
            />
            <div className="absolute w-[50vw] h-[50vw] min-w-80 min-h-80 
                            -top-32 -left-[10vw] rounded-[764px] bg-[#cdc1ff]/[.7] blur-[100px] z-0"/>
            <div className="absolute w-[70vw] h-[50vw] min-w-80 min-h-64
                            top-60 -right-[25vw] rounded-[764px] bg-[#cdc1ff]/[.7] blur-[100px] z-0"/>
        </div>
    ); 
};
